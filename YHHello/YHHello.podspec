...
Pod::Spec.new do |s|
  s.name             = 'YHHello'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YHHello.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yonghwinam/YHHello'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yonghwinam' => 'yonghwinam@smtown.com' }
  s.source           = { :git => 'https://github.com/yonghwinam/YHHello.git', :tag => s.version.to_s }
